...
export function IconPlay(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base(props)}>
      <path d="M5 3.87v16.26a1 1 0 0 0 1.53.85l13.14-8.13a1 1 0 0 0 0-1.7L6.53 3.02A1 1 0 0 0 5 3.87Z" />
    </svg>
  );
}
...
export function IconPhoneCall(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M16 2a4.5 4.5 0 0 1 4 4" />
      <path d="M15 6a2.5 2.5 0 0 1 2 2" />
    </svg>
  );
}
